...
This project is done for the partial fulfillment of credits for the course **Deep Learning: Theory and Practice(IE643)** during Autumn semster 2025-26 at IIT Bombay. The materials for this project including the report, code walkthrough, code demo, poster, etc. can be accessed from this [link](https://drive.google.com/drive/folders/122Sl4xa-G1qGfuxYvxS8EsDsL05oR0W_?usp=drive_link).
### Team members
